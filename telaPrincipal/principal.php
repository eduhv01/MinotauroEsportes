...
<body>
    ...
    <div id="cookie-banner" class="cookie-banner">
        <p>Usamos cookies para melhorar sua experiência. Ao continuar navegando, você concorda com o uso de cookies.</p>
...
<section class="hero">
    ...
    <div class="products">
        <div class="product-card">
            <img src="assets/img/produtos/coqueteleirapreta.webp" alt="Produto 1">
        ...
        <div class="product-card">
            <img src="assets/img/produtos/creatina.jpeg" alt="Produto 2">
        ...
        <div class="product-card">
            <img src="assets/img/produtos/Durateston.jpeg" alt="Produto 4">
